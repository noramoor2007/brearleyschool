 ...
 *  @author Kevin Wayne
 */
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener { // StdDraw is an implementation of the following.
    ...
    private static final String DEFAULT_WINDOW_TITLE = "Standard Drawing Helper for Advanced CS - Brearley";
    ...
    ***************************************************************************/
    ...
    public static void rectangle(double x, double y, double halfWidth, double halfHeight) {
        validate(x, "x"); // Checks if they are appropriate.
        validate(y, "y");
        ...
        draw(); // This takes a rectangle object.
    }

    public static void rectangleObject(Rectangle2D r) {
   ...
   // Our modification so we can draw rectangle objects directly
   // We still need to adjust the coordinates. Look at the 
   // rectangle() method to determine what needs to be done. 
   // public static void rectangleObject(Rectangle2D r) {
   //     offscreen.draw(r);
   //     draw();
   // }
